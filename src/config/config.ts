...
export const METADATA = {
  ...
  description: 'Luận giải Tử Vi chuyên nghiệp - Biết vận hạn, nắm cơ hội, tránh rủi ro. Nhận PDF chi tiết trong 24 giờ. Tư vấn tài lộc, quan lộc, tình cảm, sức khỏe.',
  robots: {
    index: true,
    follow: true,
  },
