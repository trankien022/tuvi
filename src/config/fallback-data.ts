...
export const FALLBACK_PACKAGES: Package[] = [
  {
    ...
    features: [
      ...
      'Nhận PDF chi tiết trong 24-48h',
...
export const FALLBACK_TESTIMONIALS: Testimonial[] = [
  {
    ...
    review: 'Dịch vụ tử vi rất chi tiết và chính xác. PDF được thiết kế đẹp mắt, dễ hiểu. Tôi rất hài lòng!',
    rating: 5,
    is_verified: true,
    created_at: new Date().toISOString(),
  },
  ...
  },
  {
    ...
    review: 'Dịch vụ chuyên nghiệp, nhận PDF nhanh chóng. Nội dung luận giải rất sâu sắc và hữu ích.',
    rating: 5,
    is_verified: true,
    created_at: new Date().toISOString(),
  },
  ...
  },
  {
    ...
    review: 'Dịch vụ tuyệt vời! PDF đẹp mắt, nội dung phong phú. Sẽ giới thiệu cho bạn bè.',
    rating: 5,
    is_verified: true,
    created_at: new Date().toISOString(),
  },
